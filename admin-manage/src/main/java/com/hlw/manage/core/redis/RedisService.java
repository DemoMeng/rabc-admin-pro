package com.hlw.manage.core.redis;
...
public class RedisService {
    ...
    public static void sendMessage(Object msg){
        redisTemplate.convertAndSend(CommonConstants.KEY_FOR_SAVE_LOG,msg);
    }
    ...
    /**
     * 如果使用keys或者smembers在大数据的情况，会出现服务器阻塞，请求堆积导致雪崩（小数据可以使用没问题）
     * scan 实现
