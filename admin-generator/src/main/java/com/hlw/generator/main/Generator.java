package com.hlw.generator.main;
...
public class Generator {
    ...
    private static void make(String[] tableNames,
        ...
        gc.setOutputDir(projectPath + "/hlw-manage/src/main/java")
                // 是否支持 AR
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                // 自定义输入文件名称
                return projectPath + "/hlw-manage/src/main/java/com/hlw/manage/"+pc.getModuleName()+"/mapper"
    ...
    public static void main(String[] args) {
        ...
        /**数据库连接信息-localhost*/
        String local_url = "jdbc:mysql://localhost:3306/hlw_manage_admin?useUnicode=true&characterEncoding=utf8&rewriteBatchedStatements=true&autoReconnect=true&serverTimezone=Asia/Shanghai";
        String local_driverName = "com.mysql.jdbc.Driver";
        String local_userName = "root";
        String local_password = "adminadmin";


        String authorName = "mqz";
        //模块名分为 open 和 manage ，open针对开放平台的后台， manage 针对4.0的后台
        String moduleName = "open";
